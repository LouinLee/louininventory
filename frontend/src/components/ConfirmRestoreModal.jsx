// src/components/ConfirmRestoreModal.jsx

import React, { useEffect } from "react";
import { motion } from "framer-motion";
import { FaUndo } from "react-icons/fa"; // ✅ Restore icon

const ConfirmRestoreModal = ({ show, onClose, onConfirm, message }) => {
    useEffect(() => {
        if (show) {
            ...
            >
                ...
                >
                    ...
                    <div className="modal-header border-0 flex-column align-items-center position-relative">
                        <FaUndo className="text-success mb-3" size={40} />
                        <h5 className="modal-title fw-bold">Confirm Restore</h5>
                        <button
                            type="button"
