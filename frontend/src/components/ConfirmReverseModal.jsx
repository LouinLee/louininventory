// src/components/ConfirmReverseModal.jsx

import React, { useEffect } from "react";
import { motion } from "framer-motion";
import { FaUndoAlt } from "react-icons/fa";

const ConfirmReverseModal = ({ show, onClose, onConfirm, message }) => {
    useEffect(() => {
        if (show) {
            ...
            >
                ...
                >
                    ...
                    <div className="modal-header border-0 flex-column align-items-center position-relative">
                        <FaUndoAlt className="text-primary mb-3" size={40} />
                        <h5 className="modal-title fw-bold">Confirm Reversal</h5>
                        <button
                            type="button"
